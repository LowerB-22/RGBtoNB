...
Die App zeigt H-alpha (656.3 nm), O III (500.7 nm), S II (672.4 nm) und He II (468.6 nm) als Super-Gauss-Profile. Die Intensitaet jeder Linie sowie deren gemeinsame Linienbreite (FWHM) zwischen 1 nm und 10 nm sind per Slider einstellbar.
...
Die Anzeige-Codes koennen mit 8, 10, 12 oder 16 Bit ausgegeben werden. Ohne Maximalnormierung werden die Sensorkanalsignale proportional zu einer festen Referenzintensitaet von 100 auf den gewaehlten Wertebereich abgebildet und bei Vollaussteuerung begrenzt. Mit Maximalnormierung wird der staerkste Kanal auf den Maximalwert gesetzt. Beide Varianten sind relative Visualisierungen und keine kalibrierten ADC-Werte.
